        ...
        <section>
            ...
            <div className={styles.sobreNos}>
                ...
                <div className={styles.sobreNos__text}>
                    <p> Nós do Aluroni oferecemos a vocês, nossos queridos clientes, 
                    ...
                    <p> Também possuímos uma cardápio de carnes com muitas opções de acordo 
                        com o seu gosto! 
                    </p>
                    <p> Para acompanhar as massas italianas, Aluroni possui uma reserva de 
